...
namespace PlayTennis.Bll
{
    public class ExercisePurposeService
    {
        ...
        public int AddPurpose(EditPurposeDto purposeDto, WxUser wxUser)
        {
            ...
            if (userLocation.Province.Equals("北京市") 
                || userLocation.Province.Equals("上海市") 
                || (userLocation.Province.Equals("广东省") && userLocation.City.Equals("深圳市"))
                || (userLocation.Province.Equals("广东省") && userLocation.City.Equals("广州市"))
                )
            {
